...
the 31 October lecture. To load the most updated version, click the orange ``update'' button at the top of the page.
...
Calculating the fused vertex weights then requires orthogonal polynomials (insert equations later).
